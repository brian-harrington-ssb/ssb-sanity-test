...
export type SlideImage = {
  ...
  media?: unknown; // Unable to locate the referenced type "slide.image.media" in schema
...
export type SertaBrandHistory = {
  _type: 'sertaBrandHistory';
  headline?: string;
  body?: string;
  ctaText?: string;
  ctaHref?: string;
...
export type SertaStoreLocator = {
  _type: 'sertaStoreLocator';
  eyebrow?: string;
  headline?: string;
  body?: string;
  ctaText?: string;
...
export type SertaAlignmentSection = {
...
export type SertaZonedComfort = {
  _type: 'sertaZonedComfort';
  eyebrow?: string;
  headline?: string;
  body?: string;
  image?: {
...
export type SertaPerfectSleeperFeature = {
  _type: 'sertaPerfectSleeperFeature';
  eyebrow?: string;
  headline?: string;
  body?: string;
  ctaText?: string;
...
export type SertaHeroCarousel = {
  _type: 'sertaHeroCarousel';
  slides?: Array<
    {
      _key: string;
    } & SertaHeroSlide
...
export type SertaPromoBanner = {
  _type: 'sertaPromoBanner';
  message?: string;
  ctaText?: string;
  ctaUrl?: string;
  backgroundColor?: string;
...
export type SertaQualityItem = {
  _type: 'sertaQualityItem';
  heading?: string;
  body?: string;
  image?: {
    asset?: SanityImageAssetReference;
...
export type SertaAdvantageFeature = {
  _type: 'sertaAdvantageFeature';
  eyebrow?: string;
  heading?: string;
  body?: string;
  image?: {
...
export type SertaTrustBadge = {
  _type: 'sertaTrustBadge';
  heading?: string;
  body?: string;
  icon?: {
    asset?: SanityImageAssetReference;
...
export type SertaMattressType = {
  _type: 'sertaMattressType';
  name?: string;
  image?: {
    asset?: SanityImageAssetReference;
    media?: unknown;
...
export type SertaCollectionItem = {
  _type: 'sertaCollectionItem';
  name?: string;
  image?: {
    asset?: SanityImageAssetReference;
    media?: unknown;
...
export type SertaHeroSlide = {
  _type: 'sertaHeroSlide';
  image?: {
    asset?: SanityImageAssetReference;
    media?: unknown;
    hotspot?: SanityImageHotspot;
...
// Query: {  '_type': 'collection',  "collection": *[_type == "collection" && store.slug.current == $collectionHandle][0] {    store {      gid,    },    template -> {      _id,      _type,      sections[] {        _key,        _type,            _type == 'richtextSection' => {  _key,  _type,  contentAlignment,  desktopContentPosition,  maxWidth,  "richtext": coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'carouselSection' => {  _key,  _type,  arrows,  autoplay,  "title": coalesce(    title[_key == $language][0].value,    title[_key == $defaultLanguage][0].value,  ),  loop,  pagination,  slides[] {    _key,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  },  slidesPerViewDesktop,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'collectionListSection' => {  _key,  _type,  collections[] -> {    store {      gid    }  },  desktopColumns,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredProductSection' => {  _key,  _type,  mediaAspectRatio,  product -> {    store {      descriptionHtml,      "firstVariant": variants[0] -> {        store {          gid,          previewImageUrl,          price        }      },      gid,      options[] {        name,        values      },      previewImageUrl,      title    }  },  'richtext': coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredCollectionSection' => {  _key,  _type,  collection -> {    store {      gid,      slug,      title    }  },  desktopColumns,  "heading": coalesce(    heading[_key == $language][0].value,    heading[_key == $defaultLanguage][0].value,  ),  maxProducts,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding},  viewAll},    _type == 'imageBannerSection' => {  _key,  _type,  backgroundImage {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  bannerHeight,  "content": coalesce(    content[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    content[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  contentAlignment,  contentPosition,  overlayOpacity,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'sertaPromoBanner' => {  _key,  _type,  message,  ctaText,  ctaUrl,  backgroundColor},    _type == 'sertaHeroCarousel' => {  _key,  _type,  autoPlayInterval,  showArrows,  showDots,  slides[] {    _key,    _type,    label,    headline,    body,    cta,    ctaHref,    theme,    imageCentered,    backgroundColor,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByCollection' => {  _key,  _type,  showShopAll,  collections[] {    _key,    _type,    name,    description,    price,    href,    featured,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByType' => {  _key,  _type,  showShopAll,  types[] {    _key,    _type,    name,    desc,    href,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaPerfectSleeperFeature' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  reversed,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaTrustBadges' => {  _key,  _type,  backgroundColor,  badges[] {    _key,    _type,    heading,    body,    link,    linkLabel,    iconUrl,    icon {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaZonedComfort' => {  _key,  _type,  eyebrow,  headline,  body,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAlignmentSection' => {  _key,  _type,  eyebrow,  headline,  ctaText,  ctaHref,  videoUrl,  posterUrl,  poster {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAdvantage' => {  _key,  _type,  backgroundColor,  features[] {    _key,    _type,    eyebrow,    heading,    body,    imageAlt,    imageUrl,    videoUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaQualityGuaranteed' => {  _key,  _type,  backgroundColor,  items[] {    _key,    _type,    heading,    body,    imageAlt,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaStoreLocator' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaBrandHistory' => {  _key,  _type,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},              _type == 'collectionBannerSection' => {  _key,  _type,  bannerHeight,  contentAlignment,  contentPosition,  overlayOpacity,  showDescription,  showImage,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'collectionProductGridSection' => {  _key,  _type,  desktopColumns,  enableFiltering,  enableSorting,  mobileColumns,  productsPerPage,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},        },    },  },  "defaultCollectionTemplate": *[_type == 'collectionTemplate' && default == true][0] {    _id,    _type,    name,    sections[] {      _key,      _type,          _type == 'richtextSection' => {  _key,  _type,  contentAlignment,  desktopContentPosition,  maxWidth,  "richtext": coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'carouselSection' => {  _key,  _type,  arrows,  autoplay,  "title": coalesce(    title[_key == $language][0].value,    title[_key == $defaultLanguage][0].value,  ),  loop,  pagination,  slides[] {    _key,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  },  slidesPerViewDesktop,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'collectionListSection' => {  _key,  _type,  collections[] -> {    store {      gid    }  },  desktopColumns,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredProductSection' => {  _key,  _type,  mediaAspectRatio,  product -> {    store {      descriptionHtml,      "firstVariant": variants[0] -> {        store {          gid,          previewImageUrl,          price        }      },      gid,      options[] {        name,        values      },      previewImageUrl,      title    }  },  'richtext': coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredCollectionSection' => {  _key,  _type,  collection -> {    store {      gid,      slug,      title    }  },  desktopColumns,  "heading": coalesce(    heading[_key == $language][0].value,    heading[_key == $defaultLanguage][0].value,  ),  maxProducts,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding},  viewAll},    _type == 'imageBannerSection' => {  _key,  _type,  backgroundImage {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  bannerHeight,  "content": coalesce(    content[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    content[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  contentAlignment,  contentPosition,  overlayOpacity,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'sertaPromoBanner' => {  _key,  _type,  message,  ctaText,  ctaUrl,  backgroundColor},    _type == 'sertaHeroCarousel' => {  _key,  _type,  autoPlayInterval,  showArrows,  showDots,  slides[] {    _key,    _type,    label,    headline,    body,    cta,    ctaHref,    theme,    imageCentered,    backgroundColor,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByCollection' => {  _key,  _type,  showShopAll,  collections[] {    _key,    _type,    name,    description,    price,    href,    featured,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByType' => {  _key,  _type,  showShopAll,  types[] {    _key,    _type,    name,    desc,    href,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaPerfectSleeperFeature' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  reversed,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaTrustBadges' => {  _key,  _type,  backgroundColor,  badges[] {    _key,    _type,    heading,    body,    link,    linkLabel,    iconUrl,    icon {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaZonedComfort' => {  _key,  _type,  eyebrow,  headline,  body,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAlignmentSection' => {  _key,  _type,  eyebrow,  headline,  ctaText,  ctaHref,  videoUrl,  posterUrl,  poster {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAdvantage' => {  _key,  _type,  backgroundColor,  features[] {    _key,    _type,    eyebrow,    heading,    body,    imageAlt,    imageUrl,    videoUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaQualityGuaranteed' => {  _key,  _type,  backgroundColor,  items[] {    _key,    _type,    heading,    body,    imageAlt,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaStoreLocator' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaBrandHistory' => {  _key,  _type,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},            _type == 'collectionBannerSection' => {  _key,  _type,  bannerHeight,  contentAlignment,  contentPosition,  overlayOpacity,  showDescription,  showImage,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'collectionProductGridSection' => {  _key,  _type,  desktopColumns,  enableFiltering,  enableSorting,  mobileColumns,  productsPerPage,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},      },  },}
...
// Source: app/data/sanity/queries.ts
// Variable: PAGE_QUERY
// Query: *[(_type == "page" && ($handle != "home" && slug.current == $handle)) || (    _type == "home" && $handle == "home"  )][0] {    _id,    _type,    sections[] {      _key,      _type,          _type == 'richtextSection' => {  _key,  _type,  contentAlignment,  desktopContentPosition,  maxWidth,  "richtext": coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'carouselSection' => {  _key,  _type,  arrows,  autoplay,  "title": coalesce(    title[_key == $language][0].value,    title[_key == $defaultLanguage][0].value,  ),  loop,  pagination,  slides[] {    _key,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  },  slidesPerViewDesktop,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'collectionListSection' => {  _key,  _type,  collections[] -> {    store {      gid    }  },  desktopColumns,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredProductSection' => {  _key,  _type,  mediaAspectRatio,  product -> {    store {      descriptionHtml,      "firstVariant": variants[0] -> {        store {          gid,          previewImageUrl,          price        }      },      gid,      options[] {        name,        values      },      previewImageUrl,      title    }  },  'richtext': coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredCollectionSection' => {  _key,  _type,  collection -> {    store {      gid,      slug,      title    }  },  desktopColumns,  "heading": coalesce(    heading[_key == $language][0].value,    heading[_key == $defaultLanguage][0].value,  ),  maxProducts,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding},  viewAll},    _type == 'imageBannerSection' => {  _key,  _type,  backgroundImage {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  bannerHeight,  "content": coalesce(    content[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    content[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  contentAlignment,  contentPosition,  overlayOpacity,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'sertaPromoBanner' => {  _key,  _type,  message,  ctaText,  ctaUrl,  backgroundColor},    _type == 'sertaHeroCarousel' => {  _key,  _type,  autoPlayInterval,  showArrows,  showDots,  slides[] {    _key,    _type,    label,    headline,    body,    cta,    ctaHref,    theme,    imageCentered,    backgroundColor,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByCollection' => {  _key,  _type,  showShopAll,  collections[] {    _key,    _type,    name,    description,    price,    href,    featured,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByType' => {  _key,  _type,  showShopAll,  types[] {    _key,    _type,    name,    desc,    href,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaPerfectSleeperFeature' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  reversed,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaTrustBadges' => {  _key,  _type,  backgroundColor,  badges[] {    _key,    _type,    heading,    body,    link,    linkLabel,    iconUrl,    icon {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaZonedComfort' => {  _key,  _type,  eyebrow,  headline,  body,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAlignmentSection' => {  _key,  _type,  eyebrow,  headline,  ctaText,  ctaHref,  videoUrl,  posterUrl,  poster {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAdvantage' => {  _key,  _type,  backgroundColor,  features[] {    _key,    _type,    eyebrow,    heading,    body,    imageAlt,    imageUrl,    videoUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaQualityGuaranteed' => {  _key,  _type,  backgroundColor,  items[] {    _key,    _type,    heading,    body,    imageAlt,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaStoreLocator' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaBrandHistory' => {  _key,  _type,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},      },    seo {      "title": coalesce(    title[_key == $language][0].value,    title[_key == $defaultLanguage][0].value,  ),      "description": coalesce(    description[_key == $language][0].value,    description[_key == $defaultLanguage][0].value,  ),      image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},    },  }
...
// Query: {  "_type": "product",  'product': *[_type == "product" && store.slug.current == $productHandle][0] {    store {      gid,    },    template -> {      _id,      _type,      sections[] {        _key,        _type,            _type == 'richtextSection' => {  _key,  _type,  contentAlignment,  desktopContentPosition,  maxWidth,  "richtext": coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'carouselSection' => {  _key,  _type,  arrows,  autoplay,  "title": coalesce(    title[_key == $language][0].value,    title[_key == $defaultLanguage][0].value,  ),  loop,  pagination,  slides[] {    _key,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  },  slidesPerViewDesktop,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'collectionListSection' => {  _key,  _type,  collections[] -> {    store {      gid    }  },  desktopColumns,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredProductSection' => {  _key,  _type,  mediaAspectRatio,  product -> {    store {      descriptionHtml,      "firstVariant": variants[0] -> {        store {          gid,          previewImageUrl,          price        }      },      gid,      options[] {        name,        values      },      previewImageUrl,      title    }  },  'richtext': coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredCollectionSection' => {  _key,  _type,  collection -> {    store {      gid,      slug,      title    }  },  desktopColumns,  "heading": coalesce(    heading[_key == $language][0].value,    heading[_key == $defaultLanguage][0].value,  ),  maxProducts,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding},  viewAll},    _type == 'imageBannerSection' => {  _key,  _type,  backgroundImage {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  bannerHeight,  "content": coalesce(    content[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    content[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  contentAlignment,  contentPosition,  overlayOpacity,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'sertaPromoBanner' => {  _key,  _type,  message,  ctaText,  ctaUrl,  backgroundColor},    _type == 'sertaHeroCarousel' => {  _key,  _type,  autoPlayInterval,  showArrows,  showDots,  slides[] {    _key,    _type,    label,    headline,    body,    cta,    ctaHref,    theme,    imageCentered,    backgroundColor,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByCollection' => {  _key,  _type,  showShopAll,  collections[] {    _key,    _type,    name,    description,    price,    href,    featured,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByType' => {  _key,  _type,  showShopAll,  types[] {    _key,    _type,    name,    desc,    href,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaPerfectSleeperFeature' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  reversed,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaTrustBadges' => {  _key,  _type,  backgroundColor,  badges[] {    _key,    _type,    heading,    body,    link,    linkLabel,    iconUrl,    icon {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaZonedComfort' => {  _key,  _type,  eyebrow,  headline,  body,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAlignmentSection' => {  _key,  _type,  eyebrow,  headline,  ctaText,  ctaHref,  videoUrl,  posterUrl,  poster {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAdvantage' => {  _key,  _type,  backgroundColor,  features[] {    _key,    _type,    eyebrow,    heading,    body,    imageAlt,    imageUrl,    videoUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaQualityGuaranteed' => {  _key,  _type,  backgroundColor,  items[] {    _key,    _type,    heading,    body,    imageAlt,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaStoreLocator' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaBrandHistory' => {  _key,  _type,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},              _type == 'productInformationSection' => {  _key,  _type,  desktopMediaPosition,  desktopMediaWidth,  mediaAspectRatio,  "richtext": coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'relatedProductsSection' => {  _key,  _type,  desktopColumns,  "heading": coalesce(    heading[_key == $language][0].value,    heading[_key == $defaultLanguage][0].value,  ),  maxProducts,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},        },    },  },  "defaultProductTemplate": *[_type == 'productTemplate' && default == true][0] {    _id,    _type,    name,    sections[] {      _key,      _type,          _type == 'richtextSection' => {  _key,  _type,  contentAlignment,  desktopContentPosition,  maxWidth,  "richtext": coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'carouselSection' => {  _key,  _type,  arrows,  autoplay,  "title": coalesce(    title[_key == $language][0].value,    title[_key == $defaultLanguage][0].value,  ),  loop,  pagination,  slides[] {    _key,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  },  slidesPerViewDesktop,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'collectionListSection' => {  _key,  _type,  collections[] -> {    store {      gid    }  },  desktopColumns,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredProductSection' => {  _key,  _type,  mediaAspectRatio,  product -> {    store {      descriptionHtml,      "firstVariant": variants[0] -> {        store {          gid,          previewImageUrl,          price        }      },      gid,      options[] {        name,        values      },      previewImageUrl,      title    }  },  'richtext': coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'featuredCollectionSection' => {  _key,  _type,  collection -> {    store {      gid,      slug,      title    }  },  desktopColumns,  "heading": coalesce(    heading[_key == $language][0].value,    heading[_key == $defaultLanguage][0].value,  ),  maxProducts,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding},  viewAll},    _type == 'imageBannerSection' => {  _key,  _type,  backgroundImage {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  bannerHeight,  "content": coalesce(    content[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    content[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  contentAlignment,  contentPosition,  overlayOpacity,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'sertaPromoBanner' => {  _key,  _type,  message,  ctaText,  ctaUrl,  backgroundColor},    _type == 'sertaHeroCarousel' => {  _key,  _type,  autoPlayInterval,  showArrows,  showDots,  slides[] {    _key,    _type,    label,    headline,    body,    cta,    ctaHref,    theme,    imageCentered,    backgroundColor,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByCollection' => {  _key,  _type,  showShopAll,  collections[] {    _key,    _type,    name,    description,    price,    href,    featured,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaShopByType' => {  _key,  _type,  showShopAll,  types[] {    _key,    _type,    name,    desc,    href,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaPerfectSleeperFeature' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  reversed,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaTrustBadges' => {  _key,  _type,  backgroundColor,  badges[] {    _key,    _type,    heading,    body,    link,    linkLabel,    iconUrl,    icon {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaZonedComfort' => {  _key,  _type,  eyebrow,  headline,  body,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAlignmentSection' => {  _key,  _type,  eyebrow,  headline,  ctaText,  ctaHref,  videoUrl,  posterUrl,  poster {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaAdvantage' => {  _key,  _type,  backgroundColor,  features[] {    _key,    _type,    eyebrow,    heading,    body,    imageAlt,    imageUrl,    videoUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaQualityGuaranteed' => {  _key,  _type,  backgroundColor,  items[] {    _key,    _type,    heading,    body,    imageAlt,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }},    _type == 'sertaStoreLocator' => {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},    _type == 'sertaBrandHistory' => {  _key,  _type,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}},            _type == 'productInformationSection' => {  _key,  _type,  desktopMediaPosition,  desktopMediaWidth,  mediaAspectRatio,  "richtext": coalesce(    richtext[_key == $language][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},    richtext[_key == $defaultLanguage][0].value[] {  ...,  _type == 'image' => {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,},  _type == 'button' => {    ...,    link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  },  _type == 'block' => {    ...,    markDefs[] {      ...,      _type == 'internalLink' => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      _type == 'externalLink' => {  _key,  _type,  link,  name,  openInNewTab,},    }  }},  )[],  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},    _type == 'relatedProductsSection' => {  _key,  _type,  desktopColumns,  "heading": coalesce(    heading[_key == $language][0].value,    heading[_key == $defaultLanguage][0].value,  ),  maxProducts,  settings {  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  customCss,  hide,  padding}},      },  },}
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_PROMO_BANNER_FRAGMENT
// Query: {  _key,  _type,  message,  ctaText,  ctaUrl,  backgroundColor}
export type SERTA_PROMO_BANNER_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  message: never;
  ctaText: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_HERO_CAROUSEL_FRAGMENT
// Query: {  _key,  _type,  autoPlayInterval,  showArrows,  showDots,  slides[] {    _key,    _type,    label,    headline,    body,    cta,    ctaHref,    theme,    imageCentered,    backgroundColor,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }}
export type SERTA_HERO_CAROUSEL_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  autoPlayInterval: never;
  showArrows: never;
  showDots: never;
  slides: never;
};
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_SHOP_BY_COLLECTION_FRAGMENT
// Query: {  _key,  _type,  showShopAll,  collections[] {    _key,    _type,    name,    description,    price,    href,    featured,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }}
export type SERTA_SHOP_BY_COLLECTION_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  showShopAll: never;
  collections: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_SHOP_BY_TYPE_FRAGMENT
// Query: {  _key,  _type,  showShopAll,  types[] {    _key,    _type,    name,    desc,    href,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }}
export type SERTA_SHOP_BY_TYPE_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  showShopAll: never;
  types: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_PERFECT_SLEEPER_FEATURE_FRAGMENT
// Query: {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  reversed,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}}
export type SERTA_PERFECT_SLEEPER_FEATURE_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  eyebrow: never;
  headline: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_TRUST_BADGES_FRAGMENT
// Query: {  _key,  _type,  backgroundColor,  badges[] {    _key,    _type,    heading,    body,    link,    linkLabel,    iconUrl,    icon {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }}
export type SERTA_TRUST_BADGES_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  backgroundColor: never;
  badges: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_ZONED_COMFORT_FRAGMENT
// Query: {  _key,  _type,  eyebrow,  headline,  body,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}}
export type SERTA_ZONED_COMFORT_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  eyebrow: never;
  headline: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_ALIGNMENT_SECTION_FRAGMENT
// Query: {  _key,  _type,  eyebrow,  headline,  ctaText,  ctaHref,  videoUrl,  posterUrl,  poster {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}}
export type SERTA_ALIGNMENT_SECTION_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  eyebrow: never;
  headline: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_ADVANTAGE_FRAGMENT
// Query: {  _key,  _type,  backgroundColor,  features[] {    _key,    _type,    eyebrow,    heading,    body,    imageAlt,    imageUrl,    videoUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }}
export type SERTA_ADVANTAGE_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  backgroundColor: never;
  features: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_QUALITY_GUARANTEED_FRAGMENT
// Query: {  _key,  _type,  backgroundColor,  items[] {    _key,    _type,    heading,    body,    imageAlt,    imageUrl,    image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}  }}
export type SERTA_QUALITY_GUARANTEED_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  backgroundColor: never;
  items: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_STORE_LOCATOR_FRAGMENT
// Query: {  _key,  _type,  eyebrow,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}}
export type SERTA_STORE_LOCATOR_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  eyebrow: never;
  headline: never;
...
// Source: app/data/sanity/sections.ts
// Variable: SERTA_BRAND_HISTORY_FRAGMENT
// Query: {  _key,  _type,  headline,  body,  ctaText,  ctaHref,  imageAlt,  imageUrl,  image {  _type,  asset,  "altText": asset -> altText,  "_ref": asset._ref,  hotspot,  crop,}}
export type SERTA_BRAND_HISTORY_FRAGMENT_RESULT = {
  _key: never;
  _type: never;
  headline: never;
  body: never;
...
declare module '@sanity/client' {
  interface SanityQueries {
    ...
    '{\n  _key,\n  _type,\n  message,\n  ctaText,\n  ctaUrl,\n  backgroundColor\n}': SERTA_PROMO_BANNER_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  autoPlayInterval,\n  showArrows,\n  showDots,\n  slides[] {\n    _key,\n    _type,\n    label,\n    headline,\n    body,\n    cta,\n    ctaHref,\n    theme,\n    imageCentered,\n    backgroundColor,\n    imageUrl,\n    image {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n  }\n}': SERTA_HERO_CAROUSEL_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  showShopAll,\n  collections[] {\n    _key,\n    _type,\n    name,\n    description,\n    price,\n    href,\n    featured,\n    imageUrl,\n    image {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n  }\n}': SERTA_SHOP_BY_COLLECTION_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  showShopAll,\n  types[] {\n    _key,\n    _type,\n    name,\n    desc,\n    href,\n    imageUrl,\n    image {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n  }\n}': SERTA_SHOP_BY_TYPE_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  eyebrow,\n  headline,\n  body,\n  ctaText,\n  ctaHref,\n  imageAlt,\n  imageUrl,\n  reversed,\n  image {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n}': SERTA_PERFECT_SLEEPER_FEATURE_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  backgroundColor,\n  badges[] {\n    _key,\n    _type,\n    heading,\n    body,\n    link,\n    linkLabel,\n    iconUrl,\n    icon {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n  }\n}': SERTA_TRUST_BADGES_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  eyebrow,\n  headline,\n  body,\n  imageAlt,\n  imageUrl,\n  image {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n}': SERTA_ZONED_COMFORT_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  eyebrow,\n  headline,\n  ctaText,\n  ctaHref,\n  videoUrl,\n  posterUrl,\n  poster {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n}': SERTA_ALIGNMENT_SECTION_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  backgroundColor,\n  features[] {\n    _key,\n    _type,\n    eyebrow,\n    heading,\n    body,\n    imageAlt,\n    imageUrl,\n    videoUrl,\n    image {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n  }\n}': SERTA_ADVANTAGE_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  backgroundColor,\n  items[] {\n    _key,\n    _type,\n    heading,\n    body,\n    imageAlt,\n    imageUrl,\n    image {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n  }\n}': SERTA_QUALITY_GUARANTEED_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  eyebrow,\n  headline,\n  body,\n  ctaText,\n  ctaHref,\n  imageAlt,\n  imageUrl,\n  image {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n}': SERTA_STORE_LOCATOR_FRAGMENT_RESULT;
    '{\n  _key,\n  _type,\n  headline,\n  body,\n  ctaText,\n  ctaHref,\n  imageAlt,\n  imageUrl,\n  image {\n  _type,\n  asset,\n  "altText": asset -> altText,\n  "_ref": asset._ref,\n  hotspot,\n  crop,\n}\n}': SERTA_BRAND_HISTORY_FRAGMENT_RESULT;
  }
}
